...
In this case, for a variable to be important, I would expect the density curves to be significantly different for the 5 classes, both in terms of the height (kurtosis) and placement (skewness). However, it is not possible to eliminate any variable based on these plots.
